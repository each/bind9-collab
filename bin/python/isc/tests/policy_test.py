...
class PolicyTest(unittest.TestCase):
    def test_keysize(self):
        ...
        print(pol.policy('good_rsa.test'))
        ...
        print(pol.policy('good_dsa.test'))
    ...
    def test_prepublish(self):
        ...
        self.assertEqual(pol.policy('good_prepublish.test').validate(),
                         (True, ""))
        self.assertEqual(pol.policy('bad_prepublish.test').validate(),
                         (True, ""))
