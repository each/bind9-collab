...
/**
 * Create the list of connections to dnsrpzd daemons.
...
/**
 * Compute the owner name of the found or result trie key.
...
/*
 * Statically link to the librpz.so DSO or not at all.
 */
static inline librpz_t *
librpz_lib_open(librpz_emsg_t *emsg, void **dl_handle, const char *path)
{
